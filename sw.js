const CACHE_NAME = 'sistema-vida-v267';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260523-sprint1-contracts-v1',
    ...
    './js/state.js?v=20260523-sprint1-contracts-v1',
    ...
    './views/onboarding.html?v=20260521-friendly-sheet-v1',

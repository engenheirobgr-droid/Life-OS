const CACHE_NAME = 'sistema-vida-v234';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260519-execution-capacity-v7',
    ...
    './js/habits.js?v=20260519-execution-capacity-v7',
    './js/protocols.js?v=20260519-execution-capacity-v7',
    './js/habitFocus.js?v=20260519-execution-capacity-v7',
    './js/state.js?v=20260519-execution-capacity-v7',
    './js/render.js?v=20260519-execution-capacity-v7',
    './js/planning.js?v=20260519-execution-capacity-v7',
    ...
    './views/planos.html?v=20260519-execution-capacity-v7',
    './views/proposito.html?v=20260516-wellbeing-prompts-v205',
    './views/perfil.html?v=20260519-execution-capacity-v7',
    './views/painel.html?v=20260519-sync-align-v1',
    './views/foco.html?v=20260519-execution-capacity-v7',

const CACHE_NAME = 'sistema-vida-v262';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260521-export-roundtrip-v1',
    ...
    './js/state.js?v=20260521-export-roundtrip-v1',
    ...
    './views/hoje.html?v=20260521-taxonomy-v2',
    './views/planos.html?v=20260521-taxonomy-v2',
    './views/proposito.html?v=20260516-wellbeing-prompts-v205',
    './views/perfil.html?v=20260521-taxonomy-v2',
    './views/painel.html?v=20260521-taxonomy-v2',
    './views/foco.html?v=20260521-taxonomy-v2',
    './views/onboarding.html?v=20260521-taxonomy-v2',
    './views/social.html?v=20260521-taxonomy-v2'
];

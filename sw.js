const CACHE_NAME = 'sistema-vida-v323';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260601-planos-icon-actions-v4',
    ...
    './js/render.js?v=20260601-planos-icon-actions-v4',
    './js/planning.js?v=20260601-planos-icon-actions-v4',
    ...
    './views/foco.html?v=20260601-planos-icon-actions-v4',

const CACHE_NAME = 'sistema-vida-v248';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260520-alignment-v1',
    ...
    './js/identity.js?v=20260520-alignment-v1',
    './js/habits.js?v=20260520-alignment-v1',
    ...
    './js/render.js?v=20260520-alignment-v1',
    ...
    './views/hoje.html?v=20260520-alignment-v1',
    './views/planos.html?v=20260520-alignment-v1',
    './views/proposito.html?v=20260516-wellbeing-prompts-v205',
    './views/perfil.html?v=20260520-alignment-v1',
    './views/painel.html?v=20260519-sync-align-v1',
    './views/foco.html?v=20260520-alignment-v1',

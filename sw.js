...
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260523-package5-focus-notes-v1',
    ...
    './js/render.js?v=20260523-package5-focus-notes-v1',
    './js/planning.js?v=20260523-package5-focus-notes-v1',
    './js/gamification.js?v=20260516-wellbeing-prompts-v205',
    './js/social.js?v=20260516-wellbeing-prompts-v205',
    './views/hoje.html?v=20260521-friendly-sheet-v1',
    './views/planos.html?v=20260521-friendly-sheet-v1',
    './views/proposito.html?v=20260521-friendly-sheet-v1',
    './views/perfil.html?v=20260523-package5-focus-notes-v1',
    './views/painel.html?v=20260521-friendly-sheet-v1',
    './views/foco.html?v=20260523-package5-focus-notes-v1',

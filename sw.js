const CACHE_NAME = 'sistema-vida-v319';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260601-foco-mobile-polish-v2',
    ...
    './js/render.js?v=20260601-foco-mobile-polish-v2',
    './js/planning.js?v=20260601-foco-mobile-polish-v2',
    ...
    './views/foco.html?v=20260601-foco-mobile-polish-v2',

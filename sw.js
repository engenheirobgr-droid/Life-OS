const CACHE_NAME = 'sistema-vida-v318';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260601-foco-mobile-polish-v1',
    ...
    './js/render.js?v=20260601-foco-mobile-polish-v1',
    './js/planning.js?v=20260601-foco-mobile-polish-v1',
    ...
    './views/foco.html?v=20260601-foco-mobile-polish-v1',

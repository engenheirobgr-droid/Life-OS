...
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260523-package5-ui-v1',
    ...
    './js/render.js?v=20260523-package5-ui-v1',
    ...
    './views/perfil.html?v=20260523-package5-ui-v1',
    './views/painel.html?v=20260521-friendly-sheet-v1',
    './views/foco.html?v=20260523-package5-ui-v1',

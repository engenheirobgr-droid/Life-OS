const CACHE_NAME = 'sistema-vida-v324';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './app.js?v=20260601-modal-desktop-v1',
    ...
    './js/render.js?v=20260601-modal-desktop-v1',
    ...
    './views/foco.html?v=20260601-modal-desktop-v1',

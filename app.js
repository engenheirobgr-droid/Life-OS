...
const app = {
    ...
    factoryReset: async function() {
      ...
      try {
        ...
        // ── Desliga listeners em tempo real para evitar que re-hidratem dados antigos ──
        ...
        // ── Grava o novo estado SEM merge (substitui completamente o documento) ──────
        await getAuthReady();
        const stateRef = doc(db, 'users', 'meu-sistema-vida');
    ...
    exportToExcel: function() {
        ...
        // PERMA
        const permaM = { P: "Emoções Positivas (P)",
...
import { attachRenderModule } from './js/render.js?v=20260601-habits-card-v5';
import { attachPlanningModule } from './js/planning.js?v=20260601-habits-card-v5';
...
const app = {
    ...
    appBuildVersion: '20260601-habits-card-v5',

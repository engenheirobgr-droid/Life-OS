...
manualGuideChapters: [
        ...
        },
        {
            ...
            what: 'O <strong>Painel</strong> agora separa duas leituras: um <strong>histórico de execução</strong> por período (semana, mes, ciclo, ano ou tudo) e uma <strong>semana atual</strong> fixa, com Saúde da semana e Encaixe semanal. A <strong>Revisão Semanal</strong> faz 5 perguntas (planejei → executei → aprendi → ajustar → próxima intenção) e liga isso ao autoconhecimento aplicado (força usada, sombra observada).',
            ...
            how: [
                ...
                'No historico de execucao, observe tendencias do periodo selecionado, nao dias isolados.',
                'Na semana atual, a Saude da semana resume execucao, carga planejada e atrasos para mostrar se a semana esta sustentavel.'
            ],
            cta: { label: 'Abrir Painel', view: 'painel' }
        },
        {

...
getStarterJourneyState: function() {
        ...
        const habitsForToday = activeHabits.filter(h => typeof this.isHabitScheduledForDate === 'function' ? this.isHabitScheduledForDate(h, today) : (h.frequency !== 'specific' || !Array.isArray(h.specificDays) || !h.specificDays.length || h.specificDays.map(String).includes(dayIndex)));
